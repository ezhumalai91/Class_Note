...
# Create and place the input box and result labels
...
hra_label = tk.Label(root, textvariable=hra_var)
hra_label.grid(row=1, column=1)

tk.Label(root, text="CA:").grid(row=2, column=0)
ca_label = tk.Label(root, textvariable=ca_var)
ca_label.grid(row=2, column=1)

tk.Label(root, text="TDS:").grid(row=3, column=0)
tds_label = tk.Label(root, textvariable=tds_var)
tds_label.grid(row=3, column=1)
