...
tk.OptionMenu(root, course_var, "Computer Science", "Mathematics", "Physics", "Chemistry").grid(row=3, column=1, padx=10, pady=10)

# Create and place the submit button
tk.Button(root, text="Submit", command=submit).grid(row=4, columnspan=3, pady=20)
